...
public class ReadServlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		String pathStr = "C:\\Users\\Vitalya\\eclipse-workspace\\lab3\\src\\main\\webapp\\myData.dat";
		...
		if(datArrayString!="") {
			ArrayList<Flower> flowers = FileHandler.readFlowersFromFile();
			jsonArrayString = gson.toJson(flowers);
		}
